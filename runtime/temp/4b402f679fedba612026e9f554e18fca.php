<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:71:"D:\phpStudy\WWW\tpblog\public/../application/admin\view\admin\edit.html";i:1569805812;s:63:"D:\phpStudy\WWW\tpblog\application\admin\view\public\_head.html";i:1569980626;s:63:"D:\phpStudy\WWW\tpblog\application\admin\view\public\_left.html";i:1569978849;s:61:"D:\phpStudy\WWW\tpblog\application\admin\view\public\_js.html";i:1568256336;}*/ ?>
                            ...
                            <div class="widget-body">
                                <form class="form-horizontal">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-6">
                                            <input type="text" class="form-control" id="username" name="username" placeholder="填写账号" value="<?php echo $adminInfo['username']; ?>" disabled/>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="oldpass" class="col-sm-2 control-label no-padding-right">原密码</label>
                                        <div class="col-sm-6">
                                            <input type="password" class="form-control" id="oldpass" name="oldpass" placeholder="填写原密码" >
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="newpass" class="col-sm-2 control-label no-padding-right">新密码</label>
                                        <div class="col-sm-6">
                                            <input type="password" class="form-control" id="newpass" name="newpass" placeholder="填写新密码" >
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="nickname" class="col-sm-2 control-label no-padding-right">昵称</label>
                                        <div class="col-sm-6">
                                            <input type="text" class="form-control" id="nickname" name="nickname" placeholder="填写昵称" value="<?php echo $adminInfo['nickname']; ?>" />
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="email" class="col-sm-2 control-label no-padding-right">邮箱</label>
                                        <div class="col-sm-6">
                                            <input type="text" class="form-control" id="email" name="email" value="<?php echo $adminInfo['email']; ?>" placeholder="填写邮箱" disabled />
                                        </div>
                                    </div>
                                    <div class="form-group">
