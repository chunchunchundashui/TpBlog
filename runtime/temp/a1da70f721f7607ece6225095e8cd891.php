<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:71:"D:\phpStudy\WWW\tpblog\public/../application/admin\view\system\set.html";i:1569980504;s:63:"D:\phpStudy\WWW\tpblog\application\admin\view\public\_head.html";i:1580814377;s:63:"D:\phpStudy\WWW\tpblog\application\admin\view\public\_left.html";i:1569978849;s:61:"D:\phpStudy\WWW\tpblog\application\admin\view\public\_js.html";i:1580895643;}*/ ?>
                        ...
                        <div class="widget radius-bordered">
                            ...
                            <div class="widget-body">
                                <form class="form-horizontal">
                                    <input type="hidden" name="id" value="<?php echo $webInfo['id']; ?>">
                                    <div class="form-group">
                                        <label for="webname" class="col-sm-2 control-label no-padding-right">网站标题</label>
                                        <div class="col-sm-6">
                                            <input type="text" class="form-control" id="webname" name="webname" placeholder="网站标题" value="<?php echo $webInfo['webname']; ?>"/>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="copyright" class="col-sm-2 control-label no-padding-right">版权信息</label>
                                        <div class="col-sm-6">
                                            <input type="text" class="form-control" id="copyright" placeholder="版权信息" name="copyright" value="<?php echo $webInfo['copyright']; ?>"/>
                                        </div>
                                    </div>
                                    <div class="form-group">
...
<script>
    $(function () {
        $('#webEdit').click(function () {
            $.ajax({
                url:"<?php echo url('admin/System/set'); ?>",
                type:'post',
                data:$('form').serialize(),
                dataType:'json',
                success:function (data) {
