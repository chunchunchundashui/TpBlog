<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:73:"D:\phpStudy\WWW\tpblog\public/../application/admin\view\article\edit.html";i:1569295709;s:63:"D:\phpStudy\WWW\tpblog\application\admin\view\public\_head.html";i:1580814377;s:63:"D:\phpStudy\WWW\tpblog\application\admin\view\public\_left.html";i:1569978849;s:61:"D:\phpStudy\WWW\tpblog\application\admin\view\public\_js.html";i:1580814326;}*/ ?>
                        ...
                        <div class="widget radius-bordered">
                            ...
                            <div class="widget-body">
                                <form action=""  class="form-horizontal">
                                    <input type="hidden" name="id" value="<?php echo $articleInfo['id']; ?>">
                                    <div class="form-group">
                                        <label for="title" class="control-label col-sm-2">文章标题</label>
                                        <div class="col-sm-6">
                                            <input type="text" class="form-control" id="title" name="title" placeholder="文章标题" value="<?php echo $articleInfo['title']; ?>"/>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="tags" class="col-sm-2 control-label no-padding-right">标签</label>
                                        <div class="col-sm-6">
                                            <input type="text" class="form-control" id="tags" name="tags" placeholder="标签" value="<?php echo $articleInfo['tags']; ?>">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <div class="checkbox col-sm-offset-2">
                                            <label>
                                                <input type="checkbox" name="is_top" value="1" <?php if($articleInfo['is_top'] == 1): ?>checked<?php endif; ?>>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-6">
                                            <select name="cateid" id="cateid" class="form-control">
                                                ...
                                                <option value="<?php echo $vo['id']; ?>" <?php if($articleInfo['cate_id'] == $vo['id']): ?>selected<?php endif; ?>><?php echo $vo['catename']; ?></option>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-6">
                                        <textarea name="desc" id="desc" cols="30" rows="5" class="form-control"><?php echo $articleInfo['desc']; ?></textarea>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="content" class="control-label col-sm-2">文章内容</label>
                                        <div class="col-sm-6">
                                            <textarea name="content" id="content" cols="30" rows="10" class=""><?php echo $articleInfo['content']; ?></textarea>
                                        </div>
                                    </div>
                                    <div class="form-group">
