<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:72:"D:\phpStudy\WWW\tpblog\public/../application/admin\view\member\edit.html";i:1569558700;s:63:"D:\phpStudy\WWW\tpblog\application\admin\view\public\_head.html";i:1569380641;s:63:"D:\phpStudy\WWW\tpblog\application\admin\view\public\_left.html";i:1569377832;s:61:"D:\phpStudy\WWW\tpblog\application\admin\view\public\_js.html";i:1568256336;}*/ ?>
                            ...
                            <div class="widget-body">
                                <form class="form-horizontal">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-6">
                                            <input type="text" class="form-control" id="username" name="username" value="<?php echo $memberInfo['username']; ?>" disabled placeholder="栏目名称" />
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="oldpass" class="col-sm-2 control-label no-padding-right">原密码</label>
                                        <div class="col-sm-6">
                                            <input type="text" class="form-control" id="oldpass" name="oldpass" placeholder="原密码" />
                                        </div>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-6">
                                            <input type="text" class="form-control" id="nickname" name="nickname" placeholder="昵称" value="<?php echo $memberInfo['nickname']; ?>">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="email" class="col-sm-2 control-label no-padding-right">邮箱</label>
                                        <div class="col-sm-6">
                                            <input type="email" class="form-control" id="email" name="email" value="<?php echo $memberInfo['email']; ?>" disabled>
                                        </div>
                                    </div>
                                    <div class="form-group">
...
<script>
    $(function () {
        $('#memberEdit').click(function () {
            $.ajax({
                url:"<?php echo url('admin/member/edit'); ?>",
                type:'post',
                data:$('form').serialize(),
                dataType:'json',
                success:function (data) {
