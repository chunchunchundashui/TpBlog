<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:74:"D:\phpStudy\WWW\tpblog\public/../application/admin\view\comment\lists.html";i:1569810491;s:63:"D:\phpStudy\WWW\tpblog\application\admin\view\public\_head.html";i:1580814377;s:63:"D:\phpStudy\WWW\tpblog\application\admin\view\public\_left.html";i:1569978849;s:61:"D:\phpStudy\WWW\tpblog\application\admin\view\public\_js.html";i:1580895643;}*/ ?>
                        ...
                        <div class="widget">
                            <div class="widget-header">
                                ...
                                <div class="widget-buttons">
                                    <?php echo replace($commets->render()); ?>
                                </div>
                            </div>
                            <div class="widget-body">
                                <table class="table table-hover table-bordered">
                                    ...
                                    <tbody>
                                    <?php if(is_array($commets) || $commets instanceof \think\Collection || $commets instanceof \think\Paginator): $i = 0; $__LIST__ = $commets;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                                    <tr>
                                        <td><?php echo $vo['id']; ?></td>
                                        <td><?php echo $vo['article']['title']; ?></td>
                                        <td><?php echo $vo['member']['nickname']; ?></td>
                                        <td><?php echo $vo['content']; ?></td>
                                        <td>
                                            <a href="<?php echo url('admin/comment/del'); ?>" class="btn btn-danger btn-xs comment-del" dataid="<?php echo $vo['id']; ?>">删除</a>
                                        </td>
                                    </tr>
