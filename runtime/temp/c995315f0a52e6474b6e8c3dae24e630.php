<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:71:"D:\phpStudy\WWW\tpblog\public/../application/admin\view\member\add.html";i:1569378687;s:63:"D:\phpStudy\WWW\tpblog\application\admin\view\public\_head.html";i:1569980626;s:63:"D:\phpStudy\WWW\tpblog\application\admin\view\public\_left.html";i:1569978849;s:61:"D:\phpStudy\WWW\tpblog\application\admin\view\public\_js.html";i:1568256336;}*/ ?>
                            ...
                            <div class="widget-body">
                                <form class="form-horizontal">
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-6">
                                            <input type="text" class="form-control" id="username" name="username" placeholder="会员账号" />
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-6">
                                            <input type="email" class="form-control" id="email" name="email" placeholder="会员邮箱" />
                                            <!--<p class="help-block">请输入栏目名称</p>-->
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <div class="col-sm-offset-2 col-sm-10">
                                            <button type="submit" class="btn btn-primary" id="memberAdd">添加</button>
                                        </div>
                                    </div>
                                </form>
                            </div>
...
<script>
    $(function () {
        $('#memberAdd').click(function () {
           $.ajax({
               url:"<?php echo url('admin/member/add'); ?>",
               type:'post',
               data:$('form').serialize(),
               dataType:'json',
               success:function (data) {
